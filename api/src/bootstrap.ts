...
const bootstrap = async () => {
    ...
    await Reclamo.create({
        Denunciante_email: "braiansilva@gmail.com",
        Denunciado_email: "diegoaraujo@gmail.com",
        reclamo: {
            nombre: 'Ayuda',
            detalle: 'El profesor no se presento a la clase',
        }
    })
    ...
    await Reclamo.create({
        ...
        Denunciado_email: "diegoaraujo@gmail.com",
        reclamo: {
            nombre: 'Devuelvame mi Dinero',
            detalle: 'Me cobró 500 pesos en la boleta de pago pero despues me pidio que le pague 300 mas',
        }
    })

    await Reclamo.create({
        Denunciante_email: "diegoaraujo@gmail.com",
        Denunciado_email: "mauroleonel@gmail.com",
        reclamo: {
            nombre: 'Ayuda',
            detalle: 'El profesor no entendia bien el contenido de la materia',
        }
    })
    ...
    await Reclamo.create({
        ...
        reclamo: {
            nombre: 'Devuelvame mi Dinero',
            detalle: 'El profesor llego media hora tarde',
        }
    })
    ...
    await Reclamo.create({
        ...
        reclamo: {
            ...
            detalle: 'El alumno estorbaba a sus compañeros e interrumpia la clase con preguntas irrelevantes',
        }
    })
    ...
    await Reclamo.create({
        ...
        reclamo: {
            ...
            detalle: 'No me sentí satisfecho con la clase',
        }
    })
