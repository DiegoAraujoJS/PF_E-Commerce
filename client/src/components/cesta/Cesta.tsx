...
export default function Cesta() {
    ...
    const [clasesPorComprar, setClasesPorComprar] = useState(false)
    ...
    useEffect(() => {
        ...
        async function getClientAndClasses() {
            ...
            let clasesPorComprarFormateadas: any = []
            console.log('3',clasesPorComprarFormateadas)
            if (clases.data.length) {
                clasesPorComprarFormateadas = clases.data.map(e => {
                    let dia = e.date.day;
            ...
            console.log('4', user.data.mail)
            setClasesPorComprar(clasesPorComprarFormateadas)
            console.log('5', clasesPorComprarFormateadas)
        }
        getClientAndClasses()
    }, [])
