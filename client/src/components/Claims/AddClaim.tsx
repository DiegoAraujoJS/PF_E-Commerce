...
function AddClaim() {
    ...
    const [user, setUser] = useState<{ name: string, lastName: string, role: number, mail: string } | undefined>({ name: '', lastName: '', role: null, mail: '' })
        ...
        let handleSubmit = async (e) => {
            ...
            if (claim) {
                if (user) {
                    ...
                    else if (!classData.Profesor_mail) {
                        return Swal.fire(
                            "Error!",
                            "Debe elejir una clase.",
                            "error"
                        )
                    }
                    else if (!claim.nombre || !claim.detalle) {
                        return Swal.fire(
                            "Error!",
                            "EL reclamo debe tener un nombre y detalles.",
                            "error"
                        )
                    }
                    else if (!admin) {
